...
CREATE TYPE order_status AS ENUM ('PENDING_PAYMENT','PAID','PACKED','SHIPPED','OUT_FOR_DELIVERY','DELIVERED','CANCELED');
CREATE TYPE payment_status AS ENUM ('PENDING','PAID','FAILED','EXPIRED','REFUNDED');
CREATE TYPE shipment_status AS ENUM ('PENDING','PICKED','IN_TRANSIT','SHIPPED','OUT_FOR_DELIVERY','DELIVERED','RETURNED');
